...
//           onChange={(e) => setSearchTerm(e.target.value)}
//         />
//         <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className="bg-gray-700 px-4 py-2 rounded">
//           <option value="recent">📅 Recently Added</option>
//           <option value="name-asc">🔤 Name (A-Z)</option>
//           <option value="name-desc">🔡 Name (Z-A)</option>
//         </select>
//         <select value={year} onChange={(e) => setYear(Number(e.target.value))} className="bg-gray-700 px-4 py-2 rounded">
//           {[2023, 2024, 2025].map((y) => (
//             <option key={y} value={y}>{y}</option>
//           ))}
//         </select>
//         <select value={month} onChange={(e) => setMonth(Number(e.target.value))} className="bg-gray-700 px-4 py-2 rounded">
//           {Array.from({ length: 12 }, (_, i) => (
