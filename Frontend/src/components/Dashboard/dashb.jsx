...
const UpdateDashboard = () => {
  const [departments] = useState(["Manager", "Accounts/Finance", "Backoffice"]);
  ...
  const cards = [
    {
      ...
      renderItem: (name) => (
        <div
          ...
          className="cursor-pointer min-w-[160px] flex-1 sm:flex-none sm:w-[180px] bg-yellow-100 hover:bg-yellow-200 p-4 rounded shadow text-center transition-all duration-300 flex items-center justify-center"
        >
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        />
        {isProfileOpen && (
          <ProfileModal closeModal={() => setProfileOpen(false)} />
        )}
      </div>
