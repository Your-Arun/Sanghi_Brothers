...
const StaffDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside
        className={`fixed inset-y-0 left-0 bg-gradient-to-b from-blue-700 to-blue-500 text-white p-6 w-64 md:w-1/4 lg:w-1/5 xl:w-1/6 z-40 shadow-xl transition-transform duration-300 ease-in-out ${
        ...
        <nav className="space-y-3">
          {navItems.map((item) => (
            <button
              ...
              className={`flex items-center gap-3 px-4 py-2 w-full rounded-lg text-left transition font-medium ${
                activeTab === item.id
      ...
      <main className="flex-1 p-4">
        ...
        <p className="text-lg text-gray-600 mb-6">Use the menu to access your features.</p>
