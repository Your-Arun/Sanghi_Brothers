...
const LubricantMangement = () => {
    ...
    const [items, setItems] = useState([
        "All stock available next 7 days",
        "Any goods order given",
        "Any goods order given payment due",
        "Stock reconcilation with accounts monthly",
        "Stock out entry in register Daily",
        "Leackage pouch mainten in a box",
        "Monthly check  physical stock",
        "Any Order goods recd.",
        "Issue lube for sale timely",
        "Any Order goods recd.put on place",
        "",
        "",
        "",
        "",
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            toast.success("Lubricant management sheet saved successfully!");
        } catch (error) {
            toast.warn("Error saving lubricant management sheet!");
        }
    };
...
export default LubricantMangement;