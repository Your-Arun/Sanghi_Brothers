  ...
  return (
    <form className="w-full flex flex-col" onSubmit={handleSubmit}>
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1.5 text-sm font-medium">Enter your details to securely sign in.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="relative group">
          ...
          <input
            ...
            className="w-full pl-12 pr-12 py-3.5 bg-gray-50/80 border border-gray-200 rounded-2xl focus:bg-white focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 outline-none transition-all text-[15px] font-medium text-gray-900"
            value={password}
      ...
      <button
        type="submit"
        className="w-full bg-orange-500 text-white py-3.5 rounded-2xl shadow-lg shadow-orange-500/30 hover:bg-orange-600 hover:shadow-orange-500/50 transition-all font-bold text-[15px] tracking-wide disabled:opacity-70"
        disabled={loading}
      >
      ...
      <p className="mt-6 mb-2 text-center text-[15px] text-gray-600 font-medium">
