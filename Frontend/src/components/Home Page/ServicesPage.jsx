...
const Services = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-gray-100 px-6 py-16">
      {/* Header Section */}
        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <div className="mt-6 flex justify-center">
              <button className="flex items-center gap-2 border border-blue-500 text-blue-600 px-4 py-2 rounded-lg hover:bg-blue-500 hover:text-white transition duration-300">
