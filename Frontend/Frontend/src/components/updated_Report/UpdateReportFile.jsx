...
const UpdateReportFile = () => {
  ...
  useEffect(() => {
    const fetchReport = async () => {
      try {
        const response = await axios.get(
          `http://localhost:5500/reportfile/${id}`
    ...
    const  Profile = async () => {
      try {
        ...
        setUserDepartment(response.data.department); // Assuming the user's department is in the 'department' field
      } catch (error) {
  ...
  if (!upreportfile) {
   ...
   // Check if the user can edit the report
  ...
  const handleSave = async (e) => {
    e.preventDefault();   
    try {
      await axios.put(`http://localhost:5500/reportfile/${id}`, upreportfile); // Adjust the URL as needed
  ...
  const handledelete=async(e)=>{
    ...
    try {
      ...
      await axios.delete(`http://localhost:5500/reportfile/${id}`); // Adjust th
      ...
      <div>
       ...
       <h1 className="text-3xl mt-5  font-thin text-center  text-red-950  mb-4">
        ...
        <div className="flex justify-evenly items-center  p-4">
          ...
          <button><img src={binImage} alt="BIN" width={50}  onClick={handledelete}/></button>
        ...
        <div className="flex justify-around">
            ...
            <table className="font-serif text-center">
              <tbody>
                ...
                <tr>
                  ...
                  <td>{upreportfile.reports.cashsales}</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div>
            <div className="text-center mt-[200px]">
              ...
              <table className="text-center p-5 justify-center mx-auto font-serif ">
                <tbody>
                  <tr className="">
                    <th>2023</th>
                    <th>2022</th>
